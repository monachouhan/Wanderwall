...
const Signup = () => {
 ...
 <button className='btn2'><img src ={pic} className="img"/><b>Sign up using Google</b></button>
    <p className='p1'>By signing up, you agreed with our Terms of<br></br>
   Services and Privacy Policy.</p>
   <p className='p2'>Already have account? <button className='btn3'><b>Log in</b></button></p>
